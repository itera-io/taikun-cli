  * taikun (Taikun CLI)
    * accounts (Manage accounts)
      * add-admin (Add an admin to an account)
      * check (Check if account name is a duplicate)
      * create (Create an account)
      * delete (Delete an account)
      * details (Get detailed information about an account)
      * disable-2fa (Disable 2FA management for an account)
      * enable-2fa (Enable 2FA management for an account)
      * groups (Manage account groups)
        * info (Get detailed information about a group)
        * list (List groups in an account)
      * list (List accounts)
      * organizations (Manage account organizations)
        * available (List available organizations for an account)
        * info (Get detailed information about an organization)
        * list (List organizations in an account)
      * projects (Manage account projects)
        * info (Get detailed information about a project)
      ...
      * users (Manage account users)
        * available (List available users for an account)
        * info (Get detailed information about a user)
    ...
    * groups (Manage groups)
      * check-duplicate-entity (Check if group name is a duplicate)
      * create (Create a group)
      * delete (Delete a group)
      * list (List groups)
      * organizations (Manage group organizations)
        * add (Add organizations to a group)
        * delete (Delete organizations from a group)
        * update (Update a group organization)
      * update (Update a group)
      * users (Manage group users)
        * add (Add users to a group)
        * delete (Delete users from a group)
    ...
    * project (Manage projects)
      ...
      * list (List projects)
      * list-subnets (List a project's cloud subnets)
      * lock (Lock a project)
    ...
    * robot (Manage robot users)
      * checker (Validate robot user creation parameters)
      * create (Create a robot user)
      * delete (Delete a robot user)
      * details (Get details of the current robot user)
      * list (List robot users)
      * regenerate (Regenerate a robot user's credentials)
      * scope-list (List available robot user scopes)
      * status (Activate or deactivate a robot user)
      * update (Update a robot user)
      * update-scope (Update a robot user's scopes)
    * repository (Explore available repositories in Taikun)
      * delete (Delete a private repository. Specify repository name and repository organization name.)
      * disable (Disable a repository. Specify repository name and repository organization name.)
      * enable (Enable a repository. Specify repository name and repository organization name.)
    ...
    * usertoken (Manage user tokens)
      ...
      * get-bearer (Get a bearer token for manual API testing)
