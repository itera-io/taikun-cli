Context 'cloudcredential/google/add'
  ...
  Example 'Cannot set both import-project and billing-account-id'
    When call taikun cloud-credential google add g --region g --zone g --import-project --billing-account-id "foo" --config-file g
  ...
  Example 'Cannot set both import-project and folder-id'
    When call taikun cloud-credential google add g --region g --zone g --import-project --folder-id "foo" --config-file g
  ...
  Example 'Must set billing-account-id if not importing a project'
    When call taikun cloud-credential google add g --region g --zone g --folder-id "foo" --config-file g
  ...
  Example 'Must set folder-id if not importing a project'
    When call taikun cloud-credential google add g --region g --zone g --billing-account-id "foo" --config-file g
