Context 'project/autoscaler/enable'
    setup() {
        ...
        pid=$(taikun project add $(_rnd_name) --cloud-credential-id $ccid  -o $oid --flavors "m1.extra_tiny" -I)
    }
    ...
    Example 'enable autoscaling succesfully'
        When call taikun project autoscaler enable $pid -n $(_rnd_name) -f "m1.extra_tiny"
