...
func stopRun(cmd *cobra.Command, opts *StopOptions) (err error) {
	...
	response, err := myApiClient.Client.StandaloneActionsAPI.StandaloneactionsStop(ctx).StopStandaloneVmCommand(body).Execute()
	if err != nil {
